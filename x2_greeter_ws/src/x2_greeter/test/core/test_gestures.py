...
def test_whole_body_gestures_use_the_waist():
    ...
    # heart is not in this list and heart_overhead is: they are two different
    # motions. The chest heart (1007) is made with the arms and takes area 3;
    # the enum's INTERACTION_SWEATHEART (3004) puts the hands above the head
    # and is whole-body. Phase 1 had only one 'heart' and it was the latter.
    for name in ('bow', 'cheer', 'heart_overhead', 'wave_chest', 'hug'):
